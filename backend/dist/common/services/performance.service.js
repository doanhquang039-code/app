...
let PerformanceService = class PerformanceService {
    dailyStatsRepo;
    monthlyStatsRepo;
    categoryPatternsRepo;
    apiLogsRepo;
    constructor(dailyStatsRepo, monthlyStatsRepo, categoryPatternsRepo, apiLogsRepo) {
        this.dailyStatsRepo = dailyStatsRepo;
        this.monthlyStatsRepo = monthlyStatsRepo;
        this.categoryPatternsRepo = categoryPatternsRepo;
        this.apiLogsRepo = apiLogsRepo;
    }
    async calculateDailyStats(userId, date) {
        const query = `
    ...
    async calculateMonthlyStats(userId, year, month) {
    ...
    async calculateCategoryPatterns(userId, year, month) {
    ...
    async calculateAllMonthlyStats() {
    ...
    async getApiPerformanceMetrics(hours = 24) {
...
], PerformanceService.prototype, "calculateAllDailyStats", null);
__decorate([
    (0, schedule_1.Cron)('0 1 1 * *'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], PerformanceService.prototype, "calculateAllMonthlyStats", null);
__decorate([
    (0, schedule_1.Cron)(schedule_1.CronExpression.EVERY_WEEK),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], PerformanceService.prototype, "cleanupOldLogs", null);
exports.PerformanceService = PerformanceService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(daily_statistics_entity_1.DailyStatistics)),
    __param(1, (0, typeorm_1.InjectRepository)(monthly_statistics_entity_1.MonthlyStatistics)),
    __param(2, (0, typeorm_1.InjectRepository)(category_pattern_entity_1.CategoryPattern)),
    __param(3, (0, typeorm_1.InjectRepository)(api_log_entity_1.ApiLog)),
