...
let DashboardController = class DashboardController {
    ...
    getRecentTransactions(req, limit) {
        return this.dashboardService.getRecentTransactions(req.user.userId, limit ? parseInt(limit) : 10);
    }
    getExpenseByCategory(req, month) {
        return this.dashboardService.getExpenseByCategory(req.user.userId, month);
    }
    getDailyTrend(req, month) {
        return this.dashboardService.getDailyTrend(req.user.userId, month);
    }
    getMonthlyComparison(req) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], DashboardController.prototype, "getDailyTrend", null);
__decorate([
